									...
									<div class="card-sigin">
										...
										<div class="main-signup-header">
											...
											<form method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="form-group">
													<label for="website-name">Websit Name</label>
                                                    <input id="website-name" type="text"
                                                      class="form-control @error('website-name') is-invalid @enderror"
                                                     name="website-name" value="{{ old('website-name') }}"
                                                     placeholder="Enter your Website Name"
                                                     required autocomplete="website-name" autofocus>
